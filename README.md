...
Results appear in the Explorer `Version Compare` TreeView. Paired items open VS Code's built-in diff viewer. Ambiguous items can be manually paired with `Pick Match...`.
